        ...
        <div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li><a href="admin_menu.php">Pending Orders <span class="sr-only"></span></a></li>
            ...
            <div>
              <div style="margin-left: 250px;">
                    ...
                    $details = array();
                    try {
                        $sql = "SELECT orders.order_id as oid, orders.order_date as date,orders.customer_id as name,orders.address as address,orders.city as city,orders.state as state,orders.zip as zipcode ,items.imagename as imagename, items.item_cost as cost FROM orders,orders_items,items,customers WHERE orders.order_id=orders_items.order_id and orders_items.items_id=items.item_id and customers.username=orders.customer_id and orders.status='delivered' ORDER BY oid DESC;";
                        ...
                        while (($row = $result->fetch_assoc())) {
                            if ($tempoid != $row['oid']) {
                                if($t==1){
                                    $i=0;
                                    echo "</table>";
                                    echo "<p class='alert alert-warning' style='margin-right :200px'><b>Total Cost $".$cost."</b></p>";
                                    $cost = 0;
                                    echo "</br></br></br>";
                                }
                                $t = 1;
